...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function sendRequest() {
				...
				var capcode = document.getElementById('captcha_code').value;


                http.open('get', 'contact_redirect.php?name=' + name1 + '&email=' + email1 + '&message=' + messge1 + '&capcode=' + capcode, true);
   ...
   echo $myvar1 ?>
        ...
        <div id="container">																																																																																																																																																																											
                        ...
                        <table width="269" height="127" border="0">
                            ...
                            <tr>
                                <td style="float:center">
                                    <img src="capctha/captcha.php?rand=<?php echo rand(); ?>" id='captchaimg'><br>
            ...
            <div class="flashdiv">
                <a href="#"><object type="application/x-shockwave-flash" data="images/books/Banner3.swf" class="flash6"/></a>
            </div>
    </body>
</html>
